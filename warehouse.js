...
// Generate more warehouses with random data
 const cities = ["Addis Abeba", "Jimma", "Metu", "Dessie", "worabe", "gonder", "mojo", "bahirdar", "tepi", "ilu", "kemise", "shire", "gore", "jimma", "Ludhiana", "Agra", "Nashik", "Kanpur", "Nagpur"];
const cropTypes = ["Wheat", "Rice", "Corn", "Soybean", "Pulses", "Cotton", "Sugarcane", "Oilseeds", "Vegetables", "Fruits", "Spices", "Tea", "Coffee", "Jute"];
const warehouseNames = [
    "addis Storage Solutions",
    "jimma Warehousing",
    "metu Storage Hub",
    "dessei Valley Storage",
    "worabe Warehousing",
    "gonder Storage Co",
    "mojo Harvest Storage",
    "tepi Valley Warehouse",
    "dessie Agri Storage",
    "ilu Storage Hub",
    "shire Storage Solutions",
    "gore Warehousing",
    "awasa Valley Storage",
    "bishoftu Storage Solutions",
    "kocha Storage Hub",
    "bonga Storage Co",
    "bale Storage Solutions",
    "Arsi Plateau Storage",
    "nekmt Warehouse",
    "gimbi Storage Hub",
    "oro Storage Co",
    "woldia Storage",
    "raya Ghats Storage",
    "halaba Plains Storage"
];
